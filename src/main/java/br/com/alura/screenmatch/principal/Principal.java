...
public class Principal {
    ...
    private void buscarEpisodioPorSerie(){
        ...
        if(serie.isPresent()){
            ...
            repositorio.save(serieEncontrada);
                    ...
                    System.out.println("Nenhum série encontrada");
                }
    }
    ...
    private void buscarSeriePorAtor() {
       System.out.println("Escolha uma série pelo ator: ");
        ...
        serieEncontradas.forEach(serie ->
    ...
    private void buscarSeriesPorCategoria() {
        System.out.println("Deseja buscar séries por categoria/genero? ");
    ...
    private void buscarEpisodiosPorData() {
        ...
        if (serieBusca.isPresent()) {
            ...
            List<Episodio> episodiosAno = repositorio.episodioPorSerieEAno(serie, ano);
